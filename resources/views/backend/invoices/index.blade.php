						...
						<td class="text-end">
							<div class="dropdown dropdown-action">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="{{route('invoices.edit',$invoice->id)}}"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
									<a class="dropdown-item" href="{{route('invoices.show',$invoice)}}"><i class="fa fa-eye m-r-5"></i> View</a>
									<a class="dropdown-item deletebtn" href="javascript:void(0)" data-id="{{$invoice->id}}"><i class="fa fa-trash-o m-r-5"></i> Xóa</a>
								</div>
							</div>
						</td>
					</tr>
