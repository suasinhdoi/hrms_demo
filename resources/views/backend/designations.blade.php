...
<div class="row align-items-center">
    <div class="col">
        <h3 class="page-title">Chức danh</h3>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Nhân Sự</a></li>
            <li class="breadcrumb-item active">Chức danh</li>
        </ul>
    </div>
    <div class="col-auto float-right ml-auto">
        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_designation"><i class="fa fa-plus"></i> Tạo chức danh</a>
    </div>
</div>
@endsection
                        ...
                        <tr>
                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a data-id="{{$designation->id}}" data-name="{{$designation->name}}" data-department="{{$designation->department->name}}" class="dropdown-item editbtn" href="javascript:void(0)" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tạo chức danh</h5>
            ...
            <div class="modal-body">
                <form action="{{route('designations')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select" name="department" title="Chọn">
