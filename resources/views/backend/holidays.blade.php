...
<div class="row align-items-center">
    <div class="col">
        <h3 class="page-title">Ngày nghỉ</h3>
        <ul class="breadcrumb">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if(!$holiday->completed)
                                                <form action="{{route('completed',$holiday)}}" method="post">
                                                    @csrf
                                                    <button data-id="{{$holiday->id}}" class="dropdown-item btn mark_as_complete" type="submit"><i class="fa fa-star m-r-5"></i>Kết thúc</button>
                                                    <input type="hidden" id="complete_id" name="id">
                                                </form>
                                            @endif
                                            <a data-id="{{$holiday->id}}" data-name="{{$holiday->name}}" data-date="{{$holiday->holiday_date}}" class="dropdown-item editbtn" href="javascript:void(0);" data-toggle="modal" data-target="#edit_holiday"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Chỉnh sửa ngày nghỉ</h5>
