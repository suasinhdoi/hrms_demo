...
<div class="row align-items-center">
	<div class="col">
		<h3 class="page-title">Danh sách tăng ca</h3>
		<ul class="breadcrumb">
	...
	<div class="col-auto float-right ml-auto">
		<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_overtime"><i class="fa fa-plus"></i> Tạo tăng ca</a>
	</div>
</div>
@endsection
                    ...
                    <tr>
                        ...
                        <td>
                            <h2 class="table-avatar blue-link">
                                ...
                                <a href="javascript:void(0)">{{ !empty($overtime->employee) ? $overtime->employee->firstname: ' '}}</a>
                            </h2>
                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tạo tăng ca</h5>
            ...
            <div class="modal-body">
                <form action="{{route('overtime')}}" method="post">
                    ...
                    <div class="form-group">
                        <label>Ngày tăng ca <span class="text-danger">*</span></label>
                        <div class="cal-icon">
                            <input class="form-control datetimepicker" name="date" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Giờ tăng ca <span class="text-danger">*</span></label>
                    ...
                    <div class="submit-section">
                        <button type="submit" class="btn btn-primary submit-btn">Tạo</button>
                    </div>
                </form>
            </div>
        </div>
...
<div id="edit_overtime" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Sửa tăng ca</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
