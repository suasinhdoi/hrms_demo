						...
						<td class="text-right">
							<div class="dropdown dropdown-action">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a data-title="{{$job->title}}" data-department="{{$job->department->id}}" data-startDate="{{$job->start_date}}" data-expiryDate="{{$job->end_date}}" data-type="{{$job->type}}" href="javscript:void(0)" class="dropdown-item editbtn" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
