                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item editbtn" href="javascript:void(0)" data-id="{{$fund->id}}" data-employee="{{$fund->employee_id}}"
                                        ...
                                        data-org_percent="{{$fund->org_share_percent}}" data-description="{{$fund->description}}"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
                                    <a class="dropdown-item deletebtn" href="javascript:void(0)" data-id="{{$fund->id}}"><i class="fa fa-trash-o m-r-5"></i> Xóa</a>
                                </div>
                            </div>
                        </td>
                    </tr>
