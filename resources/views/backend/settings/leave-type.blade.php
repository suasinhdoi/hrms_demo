                            ...
                            <td class="text-end">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item editbtn" href="javascript:void(0)" data-id="{{$leave_type->id}}" data-name="{{$leave_type->name}}" data-days="{{$leave_type->days}}"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
                                        <a class="dropdown-item deletebtn" href="javascript:void(0)" data-id="{{$leave_type->id}}"><i class="fa fa-trash-o m-r-5"></i> Xóa</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
