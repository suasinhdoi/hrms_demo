                        ...
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item editbtn" href="javascript:void(0)" data-id="{{$tax->id}}" data-name="{{$tax->name}}" data-percent="{{$tax->percentage}}" data-status="{{$tax->status}}"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
                                    <a class="dropdown-item deletebtn" href="javascript:void(0)" data-id="{{$tax->id}}"><i class="fa fa-trash-o m-r-5"></i> Xóa</a>
                                </div>
                            </div>
                        </td>
